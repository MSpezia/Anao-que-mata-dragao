...
@onready var fundo_1_1 : Sprite3D = $fundo_1_1
@onready var fundo_2 : Sprite3D = $fundo_2
@onready var fundo_3 : Sprite3D = $fundo_3

var parallax_intensity_1 = 0
var parallax_intensity_1_1 = 0.3
var parallax_intensity_2 = 0.5
var parallax_intensity_3 = 0.6
...
func _process(delta):
	...
	fundo_1_1.position.x = camera_position_x * parallax_intensity_1_1
